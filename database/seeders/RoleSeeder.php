...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'users.index'])->syncRoles([$corman]);
        Permission::create(['name' => 'users.create'])->syncRoles([$corman]);
        Permission::create(['name' => 'users.read'])->syncRoles([$corman]);
        Permission::create(['name' => 'users.update'])->syncRoles([$corman]);
        Permission::create(['name' => 'users.destroy'])->syncRoles([$corman]);
        
        
        Permission::create(['name' => 'roles.index'])->syncRoles([$corman]);
        Permission::create(['name' => 'roles.create'])->syncRoles([$corman]);
        Permission::create(['name' => 'roles.read'])->syncRoles([$corman]);
        Permission::create(['name' => 'roles.update'])->syncRoles([$corman]);
        Permission::create(['name' => 'roles.destroy'])->syncRoles([$corman]);

        Permission::create(['name' => 'tareas.index'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'tareas.create'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'tareas.read'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'tareas.update'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'tareas.destroy'])->syncRoles([$facilitie, $corman]);

        Permission::create(['name' => 'tareas.completar'])->syncRoles([$operario, $corman]);

        Permission::create(['name' => 'profile.index'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'profile.create'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'profile.read'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'profile.update'])->syncRoles([$facilitie, $corman]);
        Permission::create(['name' => 'profile.destroy'])->syncRoles([$facilitie, $corman]);
