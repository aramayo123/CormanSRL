                        ...
                        <div class="mb-5">
                            ...
                            @foreach ($roles as $role)
                                <div class="flex items-center mb-4">
                                    ...
                                    id="default-radio-{{ $role->id }}" type="radio" value="{{ $role->id }}" name="role" <?php echo ($role->id === $user->roles()) ? 'checked':''; ?> class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
