        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 ">
                    <form action="{{ route('sucursales.update', $sucursal->id) }}" method="post" class="max-w-xl mx-auto">
                        @csrf
                        @method('patch')
                        <div class="mb-5">
                            ...
                            <input type="text" id="zona" name="zona" value="{{$sucursal->zona}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ejemplo: NORTE"  />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" id="numero" name="numero" value="{{$sucursal->numero}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ejemplo: 100"  />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="sucursal" name="sucursal" value="{{$sucursal->sucursal}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ejemplo: PLAZA EMPRESAS"  />
                        ...
                        <div class="mb-5">
                            ...
                            <input type="text" id="direccion" name="direccion" value="{{$sucursal->direccion}}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ejemplo: BELGRANO 549"  />
