                ...
                <div class="p-6 text-gray-900 ">
                    <form action="{{ route('sucursales.store') }}" method="post" class="max-w-xl mx-auto">
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" id="numero" name="numero" value="{{ old('numero') }}" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Ejemplo: 100"  />
